...
@EnableJpaRepositories(basePackages = "org.bottomhalf.ec", entityManagerFactoryRef = "dbEntityManager", transactionManagerRef = "dbTransactionManager")
public class ApplicationConectionManager {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManager.setPackagesToScan("org.bottomhalf.ec");
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		sessionBuilder.scanPackages("org.bottomhalf.ec");
